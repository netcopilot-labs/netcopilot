...
def _load_firewall_policies(
    ...
    # S09-1: policy-dict construction is now a shared pure builder — one source
    # of truth for the Neo4j load (below) and the policies.json diff artifact.
    policy_params = build_firewall_policies(run_dir, site, run_id)
